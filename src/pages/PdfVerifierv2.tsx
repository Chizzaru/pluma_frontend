...
import { CheckCircle, XCircle, Clock, FileText, Shield, Upload, Download, Home } from 'lucide-react';
...
export default function PdfVerifierv2() {
  ...
  const verifySignatures = async () => {
    ...
    try {
      ...
      const response = await api.post('v1/verify-document', formData, {
        headers: {
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-6 border border-[#A1C2BD] flex items-center justify-between">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-3xl font-bold text-[#19183B]">Pluma | PDF Signature Verifier</h1>
            </div>
